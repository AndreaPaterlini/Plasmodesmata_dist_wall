...
From the MIB interface go to the Plugins tab -> Organelle Analysis -> SurfaceArea3D. A user interface will appear with multiple fields to be filled in. There is also a help section available.
