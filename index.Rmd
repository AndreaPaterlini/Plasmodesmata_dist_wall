...
* [Spatial distributions](distributions.html) **looks for patterns for how PDs are distributed over a cellular interface**
* [Cluster numbers](clusters.html) **quantifies parameters of the detected PD clusters, such as their number per interface**
* [Surface areas](surfaces.html) **calculates what proportions of the cellular surface these clusters occupy**
* [Wall thickness](wall.html) **looks for differences in thickness of the cell wall in proximity of plasmodesmata**
...
When using or editing the resources developed here please reference the paper and link to the github of [Andrea Paterlini](https://github.com/AndreaPaterlini).
