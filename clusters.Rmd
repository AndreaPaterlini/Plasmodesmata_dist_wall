...
clusters_count %>%
  ...
  ggbeeswarm::geom_quasirandom(data= clusters_count, aes(group=Genotype), colour="black", fill="black", size= 2, alpha=0.5, width=0.1, show.legend = FALSE, dodge.width = 0.9) +
